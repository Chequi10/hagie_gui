...
public:
    ...
    /*
     * connected = true:
     * STM32 conectada/reconectada.
     *
     * connected = false:
     * comunicación STM32 perdida.
     */
...
private:
    ...
    bool configAckMoveThreshold =
        false;


    bool configAckMinMovement =
        false;


    bool configAckNoMovementTimeout =
        false;


    bool configAckTargetTimeout =
        false;
    ...
    connection_callback onConnection;
    ...
    bool configCommandPending =
        false;


    uint8_t configRetryCount =
        0;
